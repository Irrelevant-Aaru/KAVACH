...
export default function Page() {
  ...
  const View = role === 'Commander' ? CommanderView : role === 'NCO / Roster' ? NcoView : role === 'Soldier' ? SoldierView : role === 'Leave Authority' ? LeaveView : role === 'Medical Team' ? MedicalView : SystemMap
